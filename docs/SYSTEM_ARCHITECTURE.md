...
> **참고**: 이 문서는 초기 설계 시점 (v1.0, 2025-12)의 아키텍처를 기술합니다.
> Sprint 1-3 완료로 REST API, 멀티카메라 파이프라인, 알림 시스템, React UI 통합이 모두 구현되었습니다.
> 현재 프로젝트 구조는 [PROJECT_STRUCTURE.md](../PROJECT_STRUCTURE.md)를 참조하세요.
