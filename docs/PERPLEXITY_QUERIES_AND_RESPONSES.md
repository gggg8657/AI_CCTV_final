...
## 검색 1: Vision-Agents Security Camera Example 이벤트 시스템

### 📤 Cursor가 Perplexity에게 보낸 쿼리
```
Vision-Agents Security Camera Example event system architecture pattern implementation 2024 2025
```

### 📥 Perplexity 응답 (원문 그대로)

#### 응답 1: Chapter 13: Pattern 5: Vision-Based Agents - The Agentic Web
...
#### 응답 2: A Vision-Based Intelligent Architecture for Security System
...
#### 응답 3: Real-Time Event Processing In Security Camera Systems
...
#### 응답 4: Computer Vision Based Smart Security System
...
#### 응답 5: Scalable Architectures for Video Surveillance Services
...
#### 응답 1: Object Detection - Ultralytics YOLO Docs
...
#### 응답 2: Ultralytics YOLO Docs: Home
...
## 검색 3: Python 이벤트 버스 Pub/Sub 패턴 구현
...
#### 응답 1: Pythonとイベント駆動：asyncio + Pub/Subモデルの設計実践
**URL**: https://qiita.com/CRUD5th/items/d7d8a39e3af150598e89

**Perplexity가 찾은 내용** (일본어 문서):
...
#### 응답 3: bubus - Production-ready python event bus library
...
#### 응답 4: Async and Sync Python Pub/Sub with Redis
...
#### 응답 5: Fast Pub-Sub python implementation: threading
...
## 검색 4: LLM Function Calling 구현 패턴
...
#### 응답 1: Function Calling - Qwen Documentation
...
#### 응답 2: Create Function-calling Agent using OpenVINO and Qwen-Agent
...
#### 응답 3: Function Calling and Tool Use | QwenLM/Qwen3
...
#### 응답 4: Qwen3 GitHub - Function Calling
...
*이 문서는 Cursor가 Perplexity에게 보낸 쿼리와 Perplexity의 응답을 명확히 구분하여 기록한 것입니다.*
